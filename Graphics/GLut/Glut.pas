...
{ Delphi conversion by Tom Nuydens
  ...
  This is a Delphi unit for the GLUT 3.6 library. GLUT allows you to
  use platform-independent window management, and also has a lot of
  useful routines to draw primitive objects, like cubes, spheres
  and teapots (of course).
  You might get runtime errors when calling glutInit(). Here's the
  correct way to initialize GLUT:

var
  cmd: array [0..X] of PChar;
  count: Integer;
  i: Integer;
begin
  ...
  This workaround is necessary because GLUT assumes you're using C,
  and thus have the command-line arguments available as parameters
  to the main() function.
  The GLUT library itself was written by Mark Kilgard of nVidia.
